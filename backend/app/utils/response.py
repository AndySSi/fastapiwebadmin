...
class HttpResponse:
    ...
    @staticmethod
    async def resp_400(
        code: int = 400, data: str = None, msg: str = "请求错误(400)"
    ) -> ORJSONResponse:
    ...
    async def resp_403(*, data: str = None, msg: str = "拒绝访问(403)") -> ORJSONResponse:
        return ORJSONResponse(
            status_code=status.HTTP_403_FORBIDDEN, content={"code": 403, "msg": msg, "data": data}
        )

    @staticmethod
    async def resp_404(*, data: str = None, msg: str = "请求出错(404)") -> ORJSONResponse:
        return ORJSONResponse(
            status_code=status.HTTP_404_NOT_FOUND, content={"code": 404, "msg": msg, "data": data}
        )
    ...
    async def resp_502(*, data: str = None, msg: str = "网络错误(502)") -> ORJSONResponse:
        return ORJSONResponse(
            status_code=status.HTTP_502_BAD_GATEWAY, content={"code": 502, "msg": msg, "data": data}
        )
    ...
    async def resp_410(
        *, data: str = None, msg: str = "请求的资源被永久删除，且不会再得到的(410)"
        ...
        return ORJSONResponse(
            status_code=status.HTTP_410_GONE, content={"code": 410, "msg": msg, "data": data}
        )
